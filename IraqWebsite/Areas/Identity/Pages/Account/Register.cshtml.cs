    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var userManagement = await _context.UserManagement.FirstOrDefaultAsync();
                if (userManagement is not null)
                {
                    if (userManagement.IsAllowedToRegister is false)
                    {
                        ModelState.AddModelError(string.Empty,"Not Allowed To Register");
                    }

                    user.IsNewUser = true;
                    if (userManagement.IsActiveByDeffult is true)
                    {
                        user.IsActive = true;
                    ...
                    //Login & Register Required Google Reqapcha
                }
                ...
                var passwordValidator = new PasswordValidator(_context).Validate(passwordViewModel);
